...
const MSR_COLUMNS = [
  ...
  { letter: "L", get: r => msrInstSerial(r, "assignTime") },
  { letter: "M", get: r => msrInstSerial(r, "acknTime") },
  { letter: "N", get: r => msrDispSerial(r.resolvedAt) },
  { letter: "O", get: r => msrInstSerial(r, "suspendTime") },
  { letter: "P", get: r => msrInstSerial(r, "resumeTime") },
