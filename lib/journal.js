 ...
 * @param {string} label entry kind label
 * @returns {Array<{label:string, time:string, author:string, text:string}>}
 */
...
/**
 * @param {object} row record with workNotes/comments/closeNotes/resolvedAt
 * @param {function} [parseDisplayMs] optional display-datetime parser
...
/** @param {Array<object>} entries @returns {Array<{key:string, author:string, items:Array<object>}>} */
