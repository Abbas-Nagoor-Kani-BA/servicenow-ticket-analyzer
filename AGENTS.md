...
```bash
node --check background.js lib/*.js analysis/*.js viewer/js/*.js panel/panel.js settings/settings.js content/content.js viewer/viewer.js && \
